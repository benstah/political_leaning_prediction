...
df_training_s = load(dirname + '/raw/training_set_s')

print("----------------- Training Set Small -----------------")
print("Rows: " + str(len(df_training_s.index)))
print(df_training_s.head())
 
df_training_l = load(dirname + '/raw/training_set_l')
...
df_gold_validation = load(dirname + '/raw/validation_set')
...
df_test = load(dirname + '/raw/test_set')
