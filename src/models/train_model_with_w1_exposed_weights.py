...
from trainer.trainer_weight_more_exposed import Trainer as t
...
# Number of epochs: 2, 3, 4
    ...
    t.train(model, train_dataloader, val_dataloader, learning_rate, epochs, "best_model_w1_exposed.pt", min_weight, max_weight)