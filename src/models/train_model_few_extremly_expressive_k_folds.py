...
# Number of epochs: 2, 3, 4
    ...
    min_weight = 0.8853821638450343
    max_weight = 0.8965624597019325
    t.train(model, train_dataloader, val_dataloader, learning_rate, epochs, "best_model_wa_extremly_exposed.pt", min_weight, max_weight)