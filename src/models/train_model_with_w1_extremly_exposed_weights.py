...
from trainer.trainer_weight_extremly_exposed import Trainer as t
from dataset.article_dataset import ArticleDataset
from dataset.article_dataset_with_weights import ArticleDatasetWithWeightOne
...
if __name__ == "__main__": 
    ...
    train_dataloader = DataLoader(ArticleDatasetWithWeightOne(train_df, tokenizer), batch_size=batch_size, shuffle=True, num_workers=1, pin_memory=True)
...
# Number of epochs: 2, 3, 4
    ...
    min_weight = 0.8768712119816516
    max_weight = 0.9148057402870143
    t.train(model, train_dataloader, val_dataloader, learning_rate, epochs, "best_model_w1_extreme_exposed.pt", min_weight, max_weight)