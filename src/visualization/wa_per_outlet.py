...
def prepareLabels(df):
    # Grouping by 'outlet' and summing the 'wa' column to get article count for each outlet
    outlet_counts = df.groupby('outlet')['wa'].mean()
...
title = 'Average weight of Sample per Outlet (WA) - Training Set S'
